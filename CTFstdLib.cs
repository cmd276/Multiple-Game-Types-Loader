...
## -------------------------------------------------------------------- onMission
function ctf::onMissionStart()
{
    initGlobalVars();
}

## -------------------------------------------------------------------- inMission
function ctf::inMissionStart()
{
    initGlobalVars();
    ...
    for(%i = 0; %i < %players; %i++)
    {
        ...
        if(%player.hasVehicle == true)
        {
            ...
            ctf::vehicle::onAdd(%vehicle);
        }
    }
}

## -------------------------------------------------------------------- Player
function ctf::player::onAdd(%this)
{
   say(%this, 0, *IDMULT_CTF_WELCOME);
}

## -------------------------------------------------------------------- Vehicle
function ctf::vehicle::onAdd(%this)
{
...
function ctf::vehicle::onDestroyed(%destroyed,%destroyer)
{
